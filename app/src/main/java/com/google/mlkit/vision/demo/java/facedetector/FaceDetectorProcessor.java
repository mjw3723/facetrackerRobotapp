...
import com.google.mlkit.vision.demo.java.FaceDetectionCallback;
...
//
//  }
  private LivePreviewActivity activity;
  ...
  public FaceDetectorProcessor(Context context, LivePreviewActivity livePreviewActivity,FaceDetectionCallback callback) {
    super(context);
    this.activity = livePreviewActivity;
  ...
  protected void onSuccess(@NonNull List<Face> faces, @NonNull GraphicOverlay graphicOverlay) {
    ...
    callback.onFaceDetected(faceDetected);
    for (Face face : faces) {
